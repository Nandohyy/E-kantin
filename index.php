          ...
          <hr class="mt-0">
              ...
              <?php 
                ...
                while($d = mysqli_fetch_array($data_barang)){
                    ?>
              <div class="col-5 pr-0">
                  <a href="?id=<?php echo $d['id_cart']; ?>" onclick="javascript:return confirm('Kamu yakin mau menghapus?');" style="text-decoration:none;">
              ...
              <div class="col-sm-12 mt-3 text-center">
                  <p>*TERIMA KASIH TELAH DATANG DI KANDOK*</p>
              </div>
              </div>
          </div>
      </div>
